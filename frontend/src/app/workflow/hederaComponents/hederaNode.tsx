...
const MEMORY_OPTIONS: MemoryOption[] = [
  {
    id: 'simple',
    name: 'Simple Memory',
    description: 'Stores in memory, so no credentials required',
    icon: '🗄️',
    category: 'beginner'
  },
  {
    ...
    description: 'Store data using Hedera Consensus Service',
    icon: '🔷',
    category: 'advanced'
  },
  {
    id: 'mongodb',
    name: 'MongoDB Memory',
    description: 'Stores the data in MongoDB collection.',
    icon: '🍃',
    category: 'advanced'
  },
  {
    id: 'redis',
    name: 'Redis Memory',
    description: 'Stores the data in Redis.',
    icon: '🔴',
    category: 'advanced'
  }
];

export default function HederaNode({
  node,
  onMouseDown,
  onDelete,
  onAddSubNode,
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm" style={{ color: '#8a9fb5' }}>
                    Choose how to store and manage your Hedera node data
                  </p>
                </div>
              </div>
              <button
